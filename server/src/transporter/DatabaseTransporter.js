...
class DatabaseTransporter {
    ...
    addAssociations() {
        ...
        this.stateTable.hasMany(this.stateQuestionTable, {foreignKey: 'state_id'});
        this.stateQuestionTable.belongsTo(this.stateTable, {foreignKey: 'state_id'});

        this.stateTable.hasMany(this.stateRecommendationTable, {foreignKey: 'state_id'});
        this.stateRecommendationTable.belongsTo(this.stateTable, {foreignKey: 'state_id'});
